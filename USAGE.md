# Project Asset Pack 完整使用说明

这份文档保留 Project Asset Pack 的全量使用细节，包括项目说明、脚本命令、Claude Code 快捷命令、Codex 自然语言入口、工作台流程、资产包流程、输出目录、多项目使用方式和安全规则。日常自然语言入口可先看 [QUICKSTART.md](QUICKSTART.md)。

...
5. `outputs/generated/workbench/06-risk-action-list.md`
6. `outputs/reviewed/workbench/human-confirmation.md`，如果存在
7. 已有 `outputs/generated/workbench/07-lifecycle-plan.md`，如果是修订
...
```text
outputs/generated/workbench/07-lifecycle-plan.md
```
